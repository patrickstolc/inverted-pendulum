...
class InvertedPendulum:
    def __init__(self, rotational=array([pi + 0.1, 0]), translational=array([0,0])):
        self.time = 0.0
        self.ctrl = 0.0
        self.rot = rotational
    ...
    def sysEq(self, y):
        ...
        dOmega = 1 / self.LENGTH * \
                 ( \
                    ...
                    -(self.ctrl / self.MASS) * cos(theta) - 0.01 * omega \
                 )
...
def main(argv):
    ...
    mlp = multilayer_perceptron(24, [24, 12, 1], ["tansig","tansig","purelin"])
